    ...
    if (loading) {
        return (
            <div className="flex items-center justify-center py-20 font-sans">
                <p className="text-gray-600 text-lg font-medium">Loading favorite articles...</p>
            </div>
        );
    }
    ...
    return (
        <div className="py-12 px-4 sm:px-6 lg:px-8 font-sans">
            <div className="max-w-4xl mx-auto">
                <h1 className="text-3xl font-extrabold text-gray-900 mb-10 text-center tracking-tight">Your Favorite Articles</h1>
                ...
                {favoriteArticles && favoriteArticles.length > 0 ? (
                    ...
                    <div className="text-center py-16 bg-white rounded-xl shadow-sm border border-gray-200">
                        ...
                        <p className="text-gray-600 text-lg font-medium mb-2">No favorite articles yet</p>
                        <p className="text-gray-500 mb-6">Explore our articles and save the ones you love.</p>
